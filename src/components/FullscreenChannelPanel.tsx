  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="grid grid-cols-[repeat(auto-fill,minmax(58px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(84px,1fr))] gap-2 max-h-[50vh] overflow-y-auto py-2 pr-1 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/20"
      >
